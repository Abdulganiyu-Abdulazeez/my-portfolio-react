        ...
        <>
            <div className="flex w-full h-[19vh] gap-[2rem] items-center justify-between bg-[#070d1b] p-[1rem] border-b-[1px] border-b-gray-700 relative">
                ...
                <div className="window md:flex hidden md:static absolute top-[19vh] left-[0vw] z-10 md:flex-row flex-col items-center items-start md:gap-[2rem] gap-0 md:w-fit w-full bg-[#070d1b]">
                    <p className="text-bold text-white md:w-fit w-full cursor-pointer hover:text-[#ffc848] md:font-normal font-bold md:p-0 p-[1rem] md:border-none border-b-[1px] border-gray-700 md:text-normal text-[20px]">Home</p>
                    <p className="text-bold text-white md:w-fit w-full cursor-pointer hover:text-[#ffc848] md:font-normal font-bold md:p-0 p-[1rem] md:border-none border-b-[1px] border-gray-700 md:text-normal text-[20px]">About</p>
                    <p className="text-bold text-white md:w-fit w-full cursor-pointer hover:text-[#ffc848] md:font-normal font-bold md:p-0 p-[1rem] md:border-none border-b-[1px] border-gray-700 md:text-normal text-[20px]">Skill</p>
                    <p className="text-bold text-white md:w-fit w-full cursor-pointer hover:text-[#ffc848] md:font-normal font-bold md:p-0 p-[1rem] md:border-none border-b-[1px] border-gray-700 md:text-normal text-[20px]">Resume</p>
                    <p className="text-bold text-white md:w-fit w-full cursor-pointer hover:text-[#ffc848] md:font-normal font-bold md:p-0 p-[1rem] md:border-none border-b-[1px] border-gray-700 md:text-normal text-[20px]">Contact</p>
