const About = () => {
    ...
    <div id="about" className="bg-[#0a101e] w-full p-[1rem] md:p-[2rem]">
        ...
        <div className="mt-[2rem] w-full flex items-center justify-between gap-[2rem] md:gap-0 md:flex-row flex-col">
            <img class="w-full md:w-[50%] md:h-[100vh] h-[60vh] z-1 static" src="./images/ghibli.png" alt="" />
            <div class="w-full md:w-[45%] flex flex-col gap-[1.2rem]">
                ...
                <a href="./images/My CV.pdf" class="bg-[#fec544] px-[4rem] py-[0.8rem] w-fit rounded-[24px] mt-[2rem]">Download Cv</a>
            </div>
        </div>
    </div>
    </> );
